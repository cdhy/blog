...
class CreateArticlesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('articles', function (Blueprint $table) {
            ...
            $table->string('subtitle', 80)->nullable()->default('')->comment('副标题');
            $table->string('slug',100)->default('')->comment('slug帮忙SEO');
            $table->string('keywords',150)->nullable()->default('')->default('')->comment('关键字');
            $table->string('description',150)->nullable()->default('')->default('')->comment('描述');
            $table->integer('click')->default(1)->comment('查看次数');
            ...
            $table->string('cover', 60)->nullable()->default('')->default('')->comment('封面');
